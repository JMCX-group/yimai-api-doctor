                ...
                '用户信息' => [
                    ...
                    '修改个人信息/修改密码/修改接诊收费信息/修改隐私设置' => [
                        ...
                        'form-data' => [
                            ...
                            'admission_set_fixed' => '接诊时间设置,固定排班; 接收json encode字符串,直接存库; 需要存7组数据,week分别是:sun,mon,tue,wed,thu,fri,sat',
                            'admission_set_flexible' => '接诊时间设置,灵活排班; 接收json encode字符串,读取时会自动过滤过期时间; 会有多组数据,格式一致',
                            'verify_switch' => '隐私设置: 添加好友验证开关; 默认值为1,即开',
                            'friends_friends_appointment_switch' => '隐私设置: 好友的好友可以向我发起约诊开关; 默认值为0,即关'
                        ],
                        'response' => [
